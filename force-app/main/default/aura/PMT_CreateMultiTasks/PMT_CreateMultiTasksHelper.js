({
      ...
      //calls CreateMultiDonationsController.getCampaignList
            ...
            action.setCallback(this, $A.getCallback(function (response) {
                ...
                if(state === "SUCCESS"){
                    ...
                    console.log('PhaseList ',JSON.stringify(data.phasesList));
                    console.log('memberList ',JSON.stringify(data.memberList));
                    component.set('v.MemberList', data.memberList);
                    component.set('v.PhaseList', data.phasesList);
                     component.set('v.TesterList', data.TesterList);
                }else if(state ==='ERROR'){ 
                    console.log('list Faild ',JSON.parse(data));
    ...
    validateTaskList: function(component, event) {
        ...
        var isValid = true;
        var taskList = component.get("v.taskList");
        //console.log('TaskList    ',JSON.parse(askList));
